...
def build():
 ...
 def shell(title,description,body,base=''):
  return f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="description" content="{e(description)}"><meta name="theme-color" content="#f7f6f2"><title>{e(title)} · De Culture Ware</title><link rel="stylesheet" href="{base}showroom.css"><script src="{base}showroom.js" defer></script></head><body><a class="skip" href="#main">Skip to content</a><header class="header wrap"><a class="brand" href="{base}index.html" aria-label="De Culture Ware home"><span class="brand-mark">dcw.</span><span class="brand-name">De Culture<br>Ware</span></a><nav aria-label="Main navigation"><a href="{base}index.html#apps">The apps</a><a href="{base}index.html#studio">The studio</a><a class="contact-link" href="mailto:feedback@howon.kim">Say hello <span aria-hidden="true">↗</span></a></nav></header>{body}<footer class="wrap footer"><a class="brand-mark" href="{base}index.html">dcw.</a><p>Small tools. Everyday possibilities.</p><span>© 2026 De Culture Ware</span><a href="mailto:feedback@howon.kim">Get in touch ↗</a></footer></body></html>'''
 def card(a):
  image=shots(a)[0]
